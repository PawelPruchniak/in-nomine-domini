...
import pl.edu.amu.home.paleografia.spring.services.JwtUserDetailsService;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal( HttpServletRequest aRequest, HttpServletResponse aResponse,
                                     FilterChain aChain ) throws ServletException, IOException {

        final String requestTokenHeader = aRequest.getHeader( "Authorization" );
