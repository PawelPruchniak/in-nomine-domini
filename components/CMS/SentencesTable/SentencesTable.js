import styles from './SentencesTable.module.css';
...
const EditIcon = ({ id }) => (
    <Tooltip title="Edytuj zadanie">
        <IconButton href={`/admin/sentences/${id}`}>
            <Edit />
        </IconButton>
    </Tooltip>
);
...
const SentencesTable = ({ data, handleDelete }) => {
                        ...
                        {(rowsPerPage > 0
                            ...
                            >
                                ...
                                <TableCell
                                    ...
                                    sx={{ border: 'none', color: '#fefefe' }}
                                >
                                    {`${row.translation.substring(0, 10)}...`}
                                </TableCell>
                                <TableCell
                                    className={styles.tableContainer}
                                    align="right"
