import styles from './TranscriptionTable.module.css';
...
const EditIcon = ({ id }) => (
    <Tooltip title="Edytuj dokument">
        <IconButton href={`/admin/transcription/${id}`}>
            <Edit />
        </IconButton>
    </Tooltip>
);
...
const TranscriptionTable = ({ data, handleDelete }) => {
